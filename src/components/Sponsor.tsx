...
const SponsorsSection: React.FC = () => {
  const sponsors: Sponsor[] = [
    {
      id: 1,
      name: "All Grace Energy",
      logo: allGraceEnergy,
      url: "#",
    },
    {
      id: 2,
      name: "Alles Charis Group",
      logo: allesCharis,
      url: "#",
    },
    {
    ...
    {
      id: 4,
      name: "Green Energy International",
      logo: greenEnergy,
      url: "#",
    },
    {
      id: 5,
      name: "Redeemed Business District",
      logo: rbd,
      url: "#",
    },
    {
  ...
  return (
    <section className="w-full py-20 bg-white relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-5">
        <div className="absolute top-0 left-0 w-64 h-64 bg-blue-500 rounded-full filter blur-3xl transform -translate-x-1/2 -translate-y-1/2" />
        <div className="absolute bottom-0 right-0 w-64 h-64 bg-red-500 rounded-full filter blur-3xl transform translate-x-1/2 translate-y-1/2" />
      </div>
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-6xl mx-auto">
          ...
          {/* Sponsors Grid - Single Row on Desktop */}
